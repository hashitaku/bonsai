...
- その他インストール
    ...
    paru -S --noconfirm gnome-keyring seahorse discord visual-studio-code-bin brave-bin gimp vlc thunderbird firefox firefox-i18n-ja spotify gnome-screenshot peek
    paru -S --noconfirm btop pipes.sh cava bat neofetch
    ```
